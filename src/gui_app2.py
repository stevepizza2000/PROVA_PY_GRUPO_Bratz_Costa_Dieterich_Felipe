...
def abrir_tela_login():
    ...
    ctk.CTkButton(login_win, text="Entrar", command=tentar_login).pack(pady=20)

    def abrir_cadastro():
        login_win.destroy()
        from gui_app import abrir_tela_cadastro
        abrir_tela_cadastro()

    ctk.CTkButton(login_win, text="Criar nova conta", command=abrir_cadastro).pack(pady=10)
